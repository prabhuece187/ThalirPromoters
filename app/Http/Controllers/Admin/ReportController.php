...
class ReportController extends Controller
{
    ...
    public function AboOverAllReport(Request $request)
    {
       $abo = AboAssign::where('tbl_abo_assign.AboId',$request->AboId)->get();

       return response($abo);
    }

    public function MediatorOverAllReport(Request $request)
    {
       $mediator = MediatorAssign::join('tbl_abo_assign','tbl_mediator_assign.AboAssignedId','tbl_abo_assign.AboAssignedId')
       ->select('tbl_mediator_assign.*','tbl_abo_assign.AboId','tbl_abo_assign.AboName')
       ->where('tbl_mediator_assign.MediatorId',$request->MediatorId)
       ->get();

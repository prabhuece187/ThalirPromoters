            ...
            <div class="row">
                <div class="col-lg-12 title-top">
                    <div class="ltn__breadcrumb-inner">
                        <h1 class="page-title banner-head-color" >Buyer Sell Right Sidebar</h1>
                        <div class="ltn__breadcrumb-list">
                            <ul class="banner-head-color">
                                <li><a href="/index"><span class="ltn__secondary-color"><i class="fas fa-home"></i></span> Home</a></li>
                                <li class="banner-head-color">Buyer Sell  Right Sidebar</li>
                            </ul>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="ltn__product-item ltn__product-item-4 text-center---">
                                ...
                                <div class="product-info">
                                    <div class="product-price">
                                        <span>BY.No - {{ $prop['BuyerSellId'] }}<label></label>
                                        </span>
                                    </div>
                                    <div class="product-price">
                                        <span>₹ {{ $prop['BudjetMin'] }} - {{ $prop['BudjetMax'] }}<label></label>
                                        </span>
                                    </div>

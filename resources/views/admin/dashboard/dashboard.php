...
<div class="row">
    ...
    <div class="col-xl-2 col-lg-2 col-md-2 col-12" ng-if="role === 1">
        <a href="#/property_follow_status" ng-if="profollow != 0 || profollow == null">
            <div class="card atag" style="padding-bottom: 8px;background-color: #101d76 !important">
                <div class="card-body">
                    <div class=" pt-2 pb-0">
                        <div class="media">
                            <div class="media-body  text-center" style="font-size:15px;">
                                <span style="color: #fff;position: relative;">ADMIN FOLLOW-UP NEW ENTRY</span>
                                <span class="span-sty" >{{profollow}}</span>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="col-xl-2 col-lg-2 col-md-2 col-12" ng-if="role === 1">
        <a href="#/mediator_follow_status" ng-if="medfollow != 0 || medfollow == null">
            <div class="card atag" style="padding-bottom: 8px;background-color: #101d76 !important">
                <div class="card-body">
                    <div class=" pt-2 pb-0">
                        <div class="media">
                            <div class="media-body  text-center" style="font-size:15px;">
                                <span style="color: #fff;position: relative;">MEDIATOR FOLLOW-UP NEW ENTRY</span>
                                <span class="span-sty" >{{medfollow}}</span>
                            </div>
                        </div>
                    </div>
                </div>

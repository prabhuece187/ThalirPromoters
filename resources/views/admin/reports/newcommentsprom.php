        ...
        <div class="card-body">
            <div class="card-block">
                <table class="table table-sm" id="table_id">
                    ...
                    <tbody class="">
                         <tr ng-repeat="site in prom">
                            <td>{{site.ProSiteId}}</td>
                            <th scope="row">{{$index+1}}</th>
                            <td><img class="img-fluid"  src="uploads/promoter/sitemap/{{site.SiteMap}}" width="50px" height="50px"></td>
                            <td ng-if="site.SiteMap == null"><img src="/uploads/main/noimg.jpg" width="60px" height="60px"></img></td>

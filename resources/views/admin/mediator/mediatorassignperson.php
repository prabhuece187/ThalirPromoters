        ...
        <div class="card-body">
            <div class="card-block">
                <table class="table table-sm " id="table_id">
                    ...
                    <tbody class="">
                        <tr ng-repeat="types in data" ng-if="id === 1 || id === types.MediatorId">
                            ...
                            <td>
                              ...
                              <a class="btn atag btn-sm btn-primary" href="#/mediator_follow/{{types.MediatorId}}/{{types.PropertyId}}"  ng-if="role == 1 || (role == 4 && types.MediatorAssignAccess === 'yes')">
                                <md-tooltip md-direction="right">FOLLOW</md-tooltip><i class="ft-phone-forwarded"></i>
                              </a>
                              <a class="btn atag btn-sm btn-primary" href="#/mediator_follow_details/{{types.MediatorId}}/{{types.PropertyId}}"  ng-if="role == 1 || (role == 4 && types.MediatorAssignAccess === 'yes')">
                      ...
                      <fieldset class="form-group floating-label-form-group">
                        <label for="title">REMARKS</label>
                         <div class="">
                            ...
                            <textarea class="form-control" ng-model="property_form.PropertyDescription" style="height: 100px !important;width: 100% !important;white-space: inherit !important;"> </textarea>
                         </div>
                      </fieldset>                
                    </div>
                    <div class="col-md-6">

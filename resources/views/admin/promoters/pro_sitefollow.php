                   ...
                   <div class="col-md-2">
                      <fieldset class="form-group floating-label-form-group">
                        <label for="title">TYPE</label>
                         <div class="">
                            <input type="text"  class="form-control" value="{{sitedetail[0].ProTypeName|app_filter:'promotertype'}}" style="border: none !important;">
                         </div>
                      </fieldset>
                   </div>
                   <div class="col-md-2">
                ...
                <table class="table table-sm" id="table_id">
                    ...
                    <tbody class="">
                        <tr ng-repeat="sites in site">
                            ...
                            <td>{{sites.FlatNo}}</td>
                            <td>{{sites.Status|app_filter:'propertystatus'}}</td>

        ...
        <div class="col-sm-12">
              <div class="card-header">
                <div class="tilte-head">
                      <h4 class="card-title"> BUYER BUY REQUEST </h4>
                </div>    
...
<div class="modal fade text-left" id="sellerrequest_form" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
       <div class="modal-content">
          <div class="modal-header">
            <!-- <h4 class="modal-title" id="myModalLabel33"><strong>{{formType}}  TYPE </strong></h4> -->
            <label class="modal-title text-text-bold-600" id="myModalLabel33">{{formType}}  BUYER  BUY REQUEST  </strong></label>
                      ...
                      <div class="col-md-3">
                        <fieldset class="form-group floating-label-form-group">
                          <label for="title">NAME</label> <div class="">
                              <input type="text" class="form-control"  ng-model="sellerrequest_form.Name">
                           </div>
                        </fieldset>                
                      </div>
                      <div class="col-md-3">
                        <fieldset class="form-group floating-label-form-group">
                          <label for="title">NUMBER</label> <div class="">
                              <input type="text" class="form-control" onlydigits maxlength="15" minlength="15" ng-model="sellerrequest_form.Number">
                           </div>
                        </fieldset>                
                      </div>
                      <div class="col-md-3">
                        <fieldset class="form-group floating-label-form-group">
                          <label for="title">TYPE</label> <div class="">
                             ...
                             <select ng-model="sellerrequest_form.TypeData"class="form-control" >
                      ...
                      <div class="col-md-3">
                        <fieldset class="form-group floating-label-form-group">
                          <label for="title">TypeDetail</label> <div class="">
                              <input type="text" class="form-control"  ng-model="sellerrequest_form.TypeDescription">
                           </div>
                        </fieldset>                
                      </div>
                      <div class="col-md-3">
                        <fieldset class="form-group floating-label-form-group">
                          <label for="title">BUDJET MIN</label>
                           <div class="">
                              <input type="text" class="form-control" onlydigits ng-model="sellerrequest_form.BudjetMin">
                           </div>
                        </fieldset>                
                      </div>
                      <div class="col-md-3">
                        <fieldset class="form-group floating-label-form-group">
                          <label for="title">BUDJET MAX</label>
                           <div class="">
                              <input type="text" class="form-control" onlydigits ng-model="sellerrequest_form.BudjetMax">
                           </div>
                        </fieldset>                
                      </div>
                      <div class="col-md-3">
                        <fieldset class="form-group floating-label-form-group">
                          <label for="title">AREA</label> <div class="">
                              <input type="text" class="form-control"  ng-model="sellerrequest_form.Area">
                           </div>
                        </fieldset>                
                      </div>
                         <div class="col-md-3">
                        <fieldset class="form-group ">
                          <label for="title">STAUS</label>
                           <div class="">                             
                            <select ng-model="sellerrequest_form.Status"class="form-control" >
                       ...
                       <div class="col-md-3">
                        <fieldset class="form-group floating-label-form-group">
                          <label for="title">EMAIL</label> <div class="">
                              <input type="text" class="form-control"  ng-model="sellerrequest_form.Email">
                           </div>
                        </fieldset>                
                      </div>
                       <div class="col-md-3">
                        <fieldset class="form-group floating-label-form-group">
                          <label for="title">FROM</label> <div class="">
                              <input type="text" class="form-control"  ng-model="sellerrequest_form .ForWhere">
                           </div>
                        </fieldset>                
                      </div>
                      <div class="col-md-6">  
                        <fieldset class="form-group floating-label-form-group">
                          <label for="title">DESCRIPTION</label>
                           <div class="">
                            <textarea class="form-control" ng-model="sellerrequest_form.PendingReason" style="height: 100px !important;width: 100%!important;white-space: inherit!important;"></textarea> 
                           </div>
                        </fieldset>
                      </div>
                    </div>   
                       ...
                       <div class="col-md-3">
                         <fieldset class="form-group floating-label-form-group">
                            <label for="title">OWNER NAME</label>
                             <div class="">
                                <input type="text"  class="form-control"  ng-model="sellerrequest_form.BuyerSellOwnerName">
                             </div>
                         </fieldset>
                      </div>
                      <div class="col-md-3">
                         <fieldset class="form-group floating-label-form-group">
                            <label for="title">OWNER NUMBER</label>
                             <div class="">
                                <input type="text" onlydigits  maxlength="10" minlength="10" class="form-control"  ng-model="sellerrequest_form.BuyerSellOwnerNumber">
                             </div>
                         </fieldset>
                      </div>
                           <div class="col-md-3">
                         <fieldset class="form-group floating-label-form-group">
                            <label for="title">REFFERD NAME</label>
                             <div class="">
                                <input type="text"  class="form-control"  ng-model="sellerrequest_form.BuyerSellReferName">
                             </div>
                         </fieldset>
                      </div>
                      <div class="col-md-3">
                         <fieldset class="form-group floating-label-form-group">
                            <label for="title">REFFERD NUMBER</label>
                             <div class="">
                                <input type="text" onlydigits  maxlength="10" minlength="10" class="form-control"  ng-model="sellerrequest_form.BuyerSellReferNumber">
                             </div>
                         </fieldset>
                      </div>
                    </div>                                   

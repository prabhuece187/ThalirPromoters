          ...
          <div class="sidebar-content">
            <div class="nav-container">
              <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
                ...
                <li class="">
                  <a href="#/property"><i class="ft-users"></i>
                ...
                <?php if ($data == 1) { ?>
                <li class="">
                  <a href="#/clientdata"><i class="ft-users"></i>
                ...
                <?php if ($data == 1) { ?>
                <li class="">
                  <a href="#/refer"><i class="ft-users"></i>
                      ...
                      <?php if ($data == 1) { ?>
                        <li class="">
                          <a href="#/customer_follow_report">
                            <span data-i18n="" class="menu-title">CUSTOMER REPORT</span>
                          </a>
                        </li > 
                      <?php }?>
                      <?php if ($data == 1) { ?>
                        <li class="">
                          <a href="#/mediator_follow_report">
                            <span data-i18n="" class="menu-title">MEDIATOR REPORT</span>
                          </a>
                        </li > 
                      <?php }?>
                  </ul>

...
<section id="hoverable-rows">
  ...
  <div class="modal fade text-left" id="asp_form" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
       <div class="modal-content">
          <div class="modal-header ">
            <!-- <h4 class="modal-title" id="myModalLabel33"><strong>{{formType}}  TYPE </strong></h4> -->
            <label class="modal-title text-text-bold-600" id="myModalLabel33">{{formType}}  ASP </strong></label>
                   ...
                   <div class="row">
                    <div class="col-md-6">
                      <fieldset class="form-group floating-label-form-group">
                        <label for="title">ASP NAME</label>
                         <div class="">
                            <input type="text" class="form-control"  ng-model="asp_form.AboName">
                         </div>
                      </fieldset>
                    </div>
                    <div class="col-md-6">
                      <fieldset class="form-group floating-label-form-group">
                        <label for="title">MOBILE NO</label>
                         <div class="">
                            <input type="text" class="form-control"  ng-model="asp_form.MobileNo">
                         </div>
                      </fieldset>
                    </div>
                    <div class="col-md-6">
                      <fieldset class="form-group floating-label-form-group">
                        <label for="title">AREA NAME</label>
                         <div class="">
                          <ui-select  required ng-model="asp_form.Area" theme="select2" >
                    ...
                    <div class="col-md-6">
                      <fieldset class="form-group floating-label-form-group">
                        <label for="title">SUB AREA</label>
                         <div class="">
                            <input type="text" class="form-control"  ng-model="asp_form.SubArea">
                         </div>
                      </fieldset>
                    </div>
                    <div class="col-md-6">
                      <fieldset class="form-group floating-label-form-group">
                        <label for="title">ADDRESS</label>
                         <div class="">
                            <input type="text" class="form-control"  ng-model="asp_form.Address">
                         </div>
                      </fieldset>
                    </div>
                  </div>

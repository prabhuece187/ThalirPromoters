<section id="hoverable-rows">
  ...
  <div class="modal fade text-left" id="mediator_form" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
       <div class="modal-content">
          <div class="modal-header ">
            <!-- <h4 class="modal-title" id="myModalLabel33"><strong>{{formType}}  TYPE </strong></h4> -->
            <label class="modal-title text-text-bold-600" id="myModalLabel33">{{formType}}  MEDIATOR </strong></label>
                    ...
                    <div class="col-md-6">
                      <fieldset class="form-group floating-label-form-group">
                        <label for="title">ABO NAME</label>
                         <div class="">
                          <ui-select  required ng-model="mediator_form.Abo" theme="select2" >
                            <ui-select-match allow-clear="true" placeholder="Select">{{$select.selected.AboName}}</ui-select-match>
                    ...
                    <div class="col-md-6">
                      <fieldset class="form-group floating-label-form-group">
                        <label for="title">AREA NAME</label>
                         <div class="">
                          <ui-select  required ng-model="mediator_form.Area" theme="select2" >

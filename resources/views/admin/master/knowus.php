        ...
        <div class="col-sm-12">
              <div class="card-header">
                <div class="tilte-head">
                      <h4 class="card-title"> HOW TO KNOW FOR US </h4>
                </div>    
                <div class="float-right">
                    <div class="row">
                      <div class="pad-lr-5 pad-top-8">
                        <a href="" ng-click="new();" class="btn atag">ADD HOW TO KNOW FOR US</a>
                      </div>
                    </div>
                </div>                             
            </div>
...
<div class="modal fade text-left" id="knowus_form" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
    <div class="modal-dialog " role="document">
       <div class="modal-content">
          <div class="modal-header ">
            <!-- <h4 class="modal-title" id="myModalLabel33"><strong>{{formType}}  TYPE </strong></h4> -->
            <label class="modal-title text-text-bold-600" id="myModalLabel33">{{formType}}  KNOW US </strong></label>
                    ...
                    <div class="col-md-12">
                      <fieldset class="form-group floating-label-form-group">
                        <label for="title"> NAME</label>
                         <div class="">
                            <input type="text" class="form-control"  ng-model="knowus_form.KnowusName">
                         </div>
                      </fieldset>                
                    </div>
                  </div>                                      

<section id="hoverable-rows">
                ...
                <div class="float-right">
                    <div class="row">
                      <div class="pad-lr-5 pad-top-8">
                        <a href="" ng-click="new();" class="btn atag">ADD ROLE</a>
                      </div>
                    </div>
                </div>                             
            </div>
        ...
        <div class="card-body">
            <div class="card-block">
                <table class="table table-sm " id="table_id">
                    ...
                    <tbody class="">
                        <tr ng-repeat="roles in data">
                            <th scope="row">{{$index+1}}</th>
                            <td>{{roles.RoleName}}</td>
                            <td>
                              <a href="" ng-click="edit($index, roles);" class="btn atag btn-sm btn-primary">
                                <md-tooltip md-direction="left">EDIT</md-tooltip><i class="ft-edit-2"></i>
                              </a>
                              <a class="btn atag btn-sm btn-primary" href="" ng-click="delete($index, roles);">
  ...
  <div class="modal fade text-left" id="role_form" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
    <div class="modal-dialog " role="document">
       <div class="modal-content">
          <div class="modal-header ">
            <!-- <h4 class="modal-title" id="myModalLabel33"><strong>{{formType}}  TYPE </strong></h4> -->
            <label class="modal-title text-text-bold-600" id="myModalLabel33">{{formType}}  ROLE </strong></label>
                   ...
                   <!--<div class="col-md-12">
                        <fieldset class="form-group floating-label-form-group">
                          <label for="title">TYPE NAME</label>
                           <div class="">
                              <ui-select  required ng-model="role_form.Type" theme="select2" autofocus>
                    ...
                    <div class="col-md-12">
                      <fieldset class="form-group floating-label-form-group">
                        <label for="title">ROLE NAME</label>
                         <div class="">
                            <input type="text" class="form-control"  ng-model="role_form.RoleName">
                         </div>
                      </fieldset>                
                    </div>
                  </div>                                      

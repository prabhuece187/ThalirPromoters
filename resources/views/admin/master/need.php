<section id="hoverable-rows">
        ...
        <div class="col-sm-12">
              <div class="card-header">
                <div class="tilte-head">
                      <h4 class="card-title"> NEED </h4>
                </div>    
                <div class="float-right">
                    <div class="row">
                      <div class="pad-lr-5 pad-top-8">
                        <a href="" ng-click="new();" class="btn atag">ADD NEED</a>
                      </div>
                    </div>
                </div>                             
            </div>
  ...
  <div class="modal fade text-left" id="need_form" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
    <div class="modal-dialog " role="document">
       <div class="modal-content">
          <div class="modal-header ">
            <!-- <h4 class="modal-title" id="myModalLabel33"><strong>{{formType}}  TYPE </strong></h4> -->
            <label class="modal-title text-text-bold-600" id="myModalLabel33">{{formType}}  NEED </strong></label>
                   ...
                   <!--<div class="col-md-12">
                        <fieldset class="form-group floating-label-form-group">
                          <label for="title">TYPE NAME</label>
                           <div class="">
                              <ui-select  required ng-model="need_form.Type" theme="select2" autofocus>
                    ...
                    <div class="col-md-12">
                      <fieldset class="form-group floating-label-form-group">
                        <label for="title">NEED NAME</label>
                         <div class="">
                            <input type="text" class="form-control"  ng-model="need_form.NeedName">
                         </div>
                      </fieldset>                
                    </div>
                  </div>                                      

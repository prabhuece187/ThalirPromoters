<section id="hoverable-rows">
                ...
                <div class="float-right">
                    <div class="row">
                      <div class="pad-lr-5 pad-top-8">
                        <a href="" ng-click="new();" class="btn atag">ADD PURPOSE</a>
                      </div>
                    </div>
                </div>                             
            </div>
  ...
  <div class="modal fade text-left" id="purpose_form" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
    <div class="modal-dialog " role="document">
       <div class="modal-content">
          <div class="modal-header ">
            <!-- <h4 class="modal-title" id="myModalLabel33"><strong>{{formType}}  TYPE </strong></h4> -->
            <label class="modal-title text-text-bold-600" id="myModalLabel33">{{formType}}  SPECIFICATION </strong></label>
                   ...
                   <div class="row">
                      <div class="col-md-6">
                        <fieldset class="form-group floating-label-form-group">
                          <label for="title">PURPOSE NAME</label>
                           <div class="">
                              <input type="text" class="form-control"  ng-model="purpose_form.PurposeName">
                           </div>
                        </fieldset>                
                      </div>
                    </div>                                      
